...
pub struct TouchRustMethods {
  ...
  pub altitude_angle: extern "C" fn(*const OpaquePtr) -> c_double,
  pub azimuth_angle: extern "C" fn(*const OpaquePtr) -> c_double,
  pub client_x: extern "C" fn(*const OpaquePtr) -> c_double,
  pub client_y: extern "C" fn(*const OpaquePtr) -> c_double,
  pub force: extern "C" fn(*const OpaquePtr) -> c_double,
  pub identifier: extern "C" fn(*const OpaquePtr) -> c_double,
  pub page_x: extern "C" fn(*const OpaquePtr) -> c_double,
  pub page_y: extern "C" fn(*const OpaquePtr) -> c_double,
  pub radius_x: extern "C" fn(*const OpaquePtr) -> c_double,
  pub radius_y: extern "C" fn(*const OpaquePtr) -> c_double,
  pub rotation_angle: extern "C" fn(*const OpaquePtr) -> c_double,
  pub screen_x: extern "C" fn(*const OpaquePtr) -> c_double,
  pub screen_y: extern "C" fn(*const OpaquePtr) -> c_double,
  pub target: extern "C" fn(*const OpaquePtr) -> RustValue<EventTargetRustMethods>,
  pub release: extern "C" fn(*const OpaquePtr) -> c_void,
  pub dynamic_to: extern "C" fn(*const OpaquePtr, type_: TouchType) -> RustValue<c_void>,
}
pub struct Touch {
