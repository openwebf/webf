        ...
        <div class="component-block">
          ...
          <div class="component-item">
            ...
            <flutter-cupertino-search-input
              ...
              @input="onSearchInput"
            />
            <div class="event-output">Current input: {{ searchText }}</div>
          </div>

          <!-- Disabled State -->
          <div class="component-item">
            <div class="item-label">Disabled State</div>
            <flutter-cupertino-search-input placeholder="Disabled search input" disabled />
          </div>
          ...
          <div class="component-item">
            ...
            <div class="search-row">
              <flutter-cupertino-search-input type="number" placeholder="Number input" />
              <flutter-cupertino-search-input type="tel" placeholder="Phone number" />
              <flutter-cupertino-search-input type="url" placeholder="URL" />
            </div>
          </div>
          ...
          <div class="component-item">
            ...
            <div class="search-row">
              <flutter-cupertino-search-input
                ...
                class="custom-radius"
              />
              <flutter-cupertino-search-input placeholder="Custom padding" class="custom-padding" />
            </div>
          </div>
          ...
          <div class="component-item">
            ...
            <flutter-cupertino-search-input
              ...
              @clear="onClear"
            />
            <div class="event-output" v-if="inputValue">Input content: {{ inputValue }}</div>
            <div class="event-output" v-if="searchValue">Search content: {{ searchValue }}</div>
            <div class="event-output" v-if="isCleared">Search input cleared</div>
          </div>
        </div>
      </div>
    </webf-listview>
