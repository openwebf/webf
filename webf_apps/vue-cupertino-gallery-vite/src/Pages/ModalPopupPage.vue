<template>
  <div id="main">
    <webf-listview id="list">
      ...
      <!-- Basic Popup -->
      <flutter-cupertino-modal-popup ref="basicPopup" height="200" @close="onPopupClose">
      ...
      <!-- Custom Popup -->
      <flutter-cupertino-modal-popup ref="customPopup" height="300" @close="onPopupClose">
        <div class="popup-content">
      ...
      <!-- Height Popup -->
      <flutter-cupertino-modal-popup ref="heightPopup" height="400" @close="onPopupClose">
        <div class="popup-content">
