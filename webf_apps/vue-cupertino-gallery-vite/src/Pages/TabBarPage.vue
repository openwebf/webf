  ...
  >
    <flutter-cupertino-tab-bar-item title="Home" icon="home" path="/home">
      <div class="tab-content">
        ...
        <flutter-cupertino-button variant="primary" @click="switchTab('/search')"
          >Switch to Search</flutter-cupertino-button
        >
      </div>
    ...
    <flutter-cupertino-tab-bar-item title="Search" icon="search" path="/search">
      <div class="tab-content">
        ...
        <flutter-cupertino-button @click="switchTab('/profile')"
          >Switch to Profile</flutter-cupertino-button
        >
      </div>
    </flutter-cupertino-tab-bar-item>
    ...
    <flutter-cupertino-tab-bar-item title="Profile" icon="person" path="/profile">
      <div class="tab-content">
        ...
        <flutter-cupertino-button @click="switchTab('/home')"
          >Back to Home</flutter-cupertino-button
        >
      </div>
    </flutter-cupertino-tab-bar-item>
  </flutter-cupertino-tab-bar>
...
<script>
import tabBarManager from '../utils/tabBarManager.js'
