  ...
  <div id="main">
    <webf-listview id="list">
      <div class="component-section">
        ...
        <div class="component-block">
          ...
          <div class="component-item">
            ...
            <div class="picker-value" v-if="cityValue">Selected: {{ cityValue }}</div>
          </div>
          ...
          <div class="component-item">
            ...
            <div class="picker-value" v-if="dateValue">Selected: {{ dateValue }}</div>
          </div>
          ...
          <div class="component-item">
            ...
            <div class="picker-value" v-if="areaValue">Selected: {{ areaValue }}</div>
          </div>
        </div>
      </div>
      ...
      <flutter-cupertino-modal-popup ref="basicPickerModal">
        <flutter-cupertino-picker height="200" item-height="44" @change="onCityChange">
      ...
      <flutter-cupertino-modal-popup ref="multiPickerModal">
        <div class="multi-picker-container">
          <flutter-cupertino-picker height="200" item-height="44" @change="onYearChange">
            <flutter-cupertino-picker-item
              v-for="year in years"
              :key="year"
              :label="year + ' Year'"
          ...
          <flutter-cupertino-picker height="200" item-height="44" @change="onMonthChange">
            <flutter-cupertino-picker-item
      ...
      <flutter-cupertino-modal-popup ref="cascadePickerModal">
        <div class="multi-picker-container">
          <flutter-cupertino-picker height="200" item-height="44" @change="onProvinceChange">
            <flutter-cupertino-picker-item
          ...
          <flutter-cupertino-picker height="200" item-height="44" @change="onCityAreaChange">
            <flutter-cupertino-picker-item
