...
class Window extends EventTarget {
  ...
  void initializeMethods(Map<String, BindingObjectMethod> methods) {
    ...
    methods['getComputedStyle'] = BindingObjectMethodSync(call: (args) => getComputedStyle(castToType<Element>(args[0])));
  }
  ...
  CSSComputedStyleDeclaration getComputedStyle(Element element) {
    return CSSComputedStyleDeclaration(element, element.tagName);
  }
