...
const DEFAULT_VIEW_BOX = Rect.fromLTWH(DEFAULT_VIEW_BOX_LEFT, DEFAULT_VIEW_BOX_TOP, DEFAULT_VIEW_BOX_WIDTH, DEFAULT_VIEW_BOX_HEIGHT);
...
class SVGSVGElement extends SVGGraphicsElement {
  ...
  Rect _viewBox = DEFAULT_VIEW_BOX;
  ...
  void initializeAttributes(Map<String, ElementAttributeProperty> attributes) {
    ...
    attributes.addAll({
      'viewBox': ElementAttributeProperty(getter: () => '${_viewBox.left} ${_viewBox.top} ${_viewBox.width} ${_viewBox.height}', setter: (val) {
  ...
  void initializeProperties(Map<String, BindingObjectProperty> properties) {
    ...
    properties.addAll({
      'viewBox': BindingObjectProperty(getter: () => {})
    });
  }
}
