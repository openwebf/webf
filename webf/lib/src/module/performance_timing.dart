...
final String PERF_PARSE_CSS_START = 'parse_css_start';
final String PERF_PARSE_CSS_END = 'parse_css_end';
final String PERF_PARSE_INLINE_CSS_START = 'parse_inline_css_start';
final String PERF_PARSE_INLINE_CSS_END = 'parse_inline_css_end';
final String PERF_MATCH_ELEMENT_RULE_START = 'match_element_rule_start';
final String PERF_MATCH_ELEMENT_RULE_END = 'match_element_rule_end';
final String PERF_FLUSH_STYLE_START = 'flush_style_start';
final String PERF_FLUSH_STYLE_END = 'flush_style_end';
...
final String PERF_WIDGET_LAYOUT_START = 'widget_layout_start';
final String PERF_WIDGET_LAYOUT_END = 'widget_layout_end';
