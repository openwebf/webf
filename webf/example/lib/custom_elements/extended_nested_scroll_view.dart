// ignore_for_file: unnecessary_cast, prefer_asserts_with_message, avoid_private_typedef_functions, avoid_multiple_declarations_per_line, curly_braces_in_flow_control_structures, no_leading_underscores_for_local_identifiers, comment_references, avoid_positional_boolean_parameters, always_put_required_named_parameters_first, parameter_assignments
...
class ExtendedNestedScrollView extends StatefulWidget {
  ...
  List<Widget> _buildSlivers(
      BuildContext context, ScrollController innerController, bool bodyIsScrolled) {
    return <Widget>[
...
class _NestedScrollCoordinator implements ScrollActivityDelegate, ScrollHoldController {
  ...
  void beginActivity(
      ScrollActivity newOuterActivity, _NestedScrollActivityGetter innerActivityGetter) {
...
class _NestedOuterBallisticScrollActivity extends BallisticScrollActivity {
  ...
  bool applyMoveTo(double value) {
    ...
    super.applyMoveTo(value + metrics.correctionOffset);
