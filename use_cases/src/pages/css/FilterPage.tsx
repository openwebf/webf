...
const FilterDemo: React.FC<FilterDemoProps> = ({ title, filterClass, description }) => {
  return (
    <div className="bg-white p-4 rounded-xl shadow-sm flex flex-col items-center gap-4 w-full">
...
export const FilterPage: React.FC = () => {
  return (
    <div className="w-full h-full bg-gray-50">
      <WebFListView className="p-5 flex flex-col gap-5 w-full box-border">
