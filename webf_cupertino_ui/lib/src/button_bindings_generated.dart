...
abstract class FlutterCupertinoButtonBindings extends WidgetElement {
  ...
  void initializeAttributes(Map<String, ElementAttributeProperty> attributes) {
    ...
    attributes['disabled-color'] = ElementAttributeProperty(
      getter: () => disabledColor?.toString(),
      setter: (value) => disabledColor = value,
      deleter: () => disabledColor = null
    );
  }
  static StaticDefinedBindingPropertyMap flutterCupertinoButtonProperties = {
    ...
    'disabledColor': StaticDefinedBindingProperty(
      getter: (element) => castToType<FlutterCupertinoButtonBindings>(element).disabledColor,
      setter: (element, value) =>
      castToType<FlutterCupertinoButtonBindings>(element).disabledColor = value,
    ),
  };
  @override
