...
use crate::*;
#[repr(C)]
pub struct HTMLHeadElementRustMethods {
  pub version: c_double,
  pub html_element: HTMLElementRustMethods,
}
pub struct HTMLHeadElement {
  pub html_element: HTMLElement,
  method_pointer: *const HTMLHeadElementRustMethods,
}
impl HTMLHeadElement {
  pub fn initialize(ptr: *const OpaquePtr, context: *const ExecutingContext, method_pointer: *const HTMLHeadElementRustMethods, status: *const RustValueStatus) -> HTMLHeadElement {
    unsafe {
      HTMLHeadElement {
...
pub trait HTMLHeadElementMethods: HTMLElementMethods {
  fn as_html_head_element(&self) -> &HTMLHeadElement;
}
impl HTMLHeadElementMethods for HTMLHeadElement {
  fn as_html_head_element(&self) -> &HTMLHeadElement {
    self
  }
}
impl HTMLElementMethods for HTMLHeadElement {
...
impl NodeMethods for HTMLHeadElement {
...
impl EventTargetMethods for HTMLHeadElement {
