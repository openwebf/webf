...
use crate::*;
#[repr(C)]
pub struct HTMLBodyElementRustMethods {
  pub version: c_double,
  pub html_element: HTMLElementRustMethods,
}
pub struct HTMLBodyElement {
  pub html_element: HTMLElement,
  method_pointer: *const HTMLBodyElementRustMethods,
}
impl HTMLBodyElement {
  pub fn initialize(ptr: *const OpaquePtr, context: *const ExecutingContext, method_pointer: *const HTMLBodyElementRustMethods, status: *const RustValueStatus) -> HTMLBodyElement {
    unsafe {
      HTMLBodyElement {
...
pub trait HTMLBodyElementMethods: HTMLElementMethods {
  fn as_html_body_element(&self) -> &HTMLBodyElement;
}
...
impl HTMLElementMethods for HTMLBodyElement {
...
impl NodeMethods for HTMLBodyElement {
...
impl EventTargetMethods for HTMLBodyElement {
