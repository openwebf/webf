...
use crate::*;
#[repr(C)]
pub struct HTMLHtmlElementRustMethods {
  pub version: c_double,
  pub html_element: HTMLElementRustMethods,
}
pub struct HTMLHtmlElement {
  pub html_element: HTMLElement,
  method_pointer: *const HTMLHtmlElementRustMethods,
}
impl HTMLHtmlElement {
  pub fn initialize(ptr: *const OpaquePtr, context: *const ExecutingContext, method_pointer: *const HTMLHtmlElementRustMethods, status: *const RustValueStatus) -> HTMLHtmlElement {
    unsafe {
      HTMLHtmlElement {
...
pub trait HTMLHtmlElementMethods: HTMLElementMethods {
  fn as_html_html_element(&self) -> &HTMLHtmlElement;
}
impl HTMLHtmlElementMethods for HTMLHtmlElement {
  fn as_html_html_element(&self) -> &HTMLHtmlElement {
    self
  }
}
...
impl NodeMethods for HTMLHtmlElement {
...
impl EventTargetMethods for HTMLHtmlElement {
