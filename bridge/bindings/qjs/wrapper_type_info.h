...
enum {
  ...
  JS_CLASS_HTML_STYLE_ELEMENT,
  JS_CLASS_HTMLI_FRAME_ELEMENT,
  JS_CLASS_HTML_ANCHOR_ELEMENT,
  JS_CLASS_HTML_LINK_ELEMENT,
  JS_CLASS_HTML_BR_ELEMENT,
  JS_CLASS_HTML_CANVAS_ELEMENT,
  JS_CLASS_HTML_STYLE_SHEET,
  JS_CLASS_STYLE_SHEET,
  JS_CLASS_IMAGE,
  JS_CLASS_IMAGE_BITMAP,
  ...
  JS_CLASS_HTML_LABEL_ELEMENT,
  JS_CLASS_WEB_F_TOUCH_AREA_ELEMENT,
  JS_CLASS_WEB_F_ROUTER_LINK_ELEMENT,
  JS_CLASS_HTML_PARAGRAPH_ELEMENT,
  JS_CLASS_HTML_HEADING_ELEMENT,
  JS_CLASS_HTML_U_LIST_ELEMENT,
  JS_CLASS_HTML_O_LIST_ELEMENT,
  JS_CLASS_HTML_LI_ELEMENT,
  JS_CLASS_HTML_STRONG_ELEMENT,
  JS_CLASS_HTML_EM_ELEMENT,
  JS_CLASS_HTML_CODE_ELEMENT,
  JS_CLASS_HTML_SPAN_ELEMENT,
  JS_CLASS_HTML_PRE_ELEMENT,
  JS_CLASS_HTML_QUOTE_ELEMENT,
  JS_CLASS_HTML_ARTICLE_ELEMENT,
  JS_CLASS_HTML_SECTION_ELEMENT,
  JS_CLASS_HTML_HEADER_ELEMENT,
  JS_CLASS_HTML_FOOTER_ELEMENT,
  JS_CLASS_HTML_NAV_ELEMENT,
  JS_CLASS_HTML_BOLD_ELEMENT,
  JS_CLASS_HTML_ITALIC_ELEMENT,
  JS_CLASS_HTML_UNDERLINE_ELEMENT,
  JS_CLASS_HTML_STRIKETHROUGH_ELEMENT,
  JS_CLASS_HTML_MARK_ELEMENT,
  JS_CLASS_HTML_SMALL_ELEMENT,
  JS_CLASS_HTML_HR_ELEMENT,
  JS_CLASS_HTML_ABBR_ELEMENT,
  JS_CLASS_HTML_CITE_ELEMENT,
  JS_CLASS_HTML_KBD_ELEMENT,
  JS_CLASS_HTML_VAR_ELEMENT,
  JS_CLASS_HTML_DFN_ELEMENT,
  JS_CLASS_HTML_SAMP_ELEMENT,
  JS_CLASS_HTML_DATA_ELEMENT,
  JS_CLASS_HTML_TIME_ELEMENT,
  JS_CLASS_HTML_DL_ELEMENT,
  JS_CLASS_HTML_DT_ELEMENT,
  JS_CLASS_HTML_DD_ELEMENT,
  JS_CLASS_HTML_FIGURE_ELEMENT,
  JS_CLASS_HTML_FIG_CAPTION_ELEMENT,
  JS_CLASS_HTML_ADDRESS_ELEMENT,
  JS_CLASS_HTML_ASIDE_ELEMENT,
  JS_CLASS_HTML_MAIN_ELEMENT,
  JS_CLASS_HTML_DEL_ELEMENT,
  JS_CLASS_HTML_INS_ELEMENT,
  JS_CLASS_HTML_SELECT_ELEMENT,
  JS_CLASS_HTML_OPT_GROUP_ELEMENT,
  JS_CLASS_HTML_OPTION_ELEMENT,
  JS_CLASS_HTML_TITLE_ELEMENT,
  JS_CLASS_HTML_META_ELEMENT,
  JS_CLASS_HTML_NO_SCRIPT_ELEMENT,
  JS_CLASS_CSS_STYLE_DECLARATION,
  JS_CLASS_INLINE_CSS_STYLE_DECLARATION,
  JS_CLASS_COMPUTED_CSS_STYLE_DECLARATION,
  JS_CLASS_IDLE_DEADLINE,
  JS_CLASS_DOM_TOKEN_LIST,
  JS_CLASS_DOM_STRING_MAP,
  JS_CLASS_LEGACY_CSS_STYLE_DECLARATION,
  JS_CLASS_LEGACY_INLINE_CSS_STYLE_DECLARATION,
  JS_CLASS_LEGACY_COMPUTED_CSS_STYLE_DECLARATION,

  JS_CLASS_NATIVE_LOADER,

  // CSS
  JS_CLASS_CSS_RULE,
  JS_CLASS_CSS_STYLE_SHEET,
  JS_CLASS_CSS_RULE_LIST,
  JS_CLASS_MEDIA_LIST,
  JS_CLASS_CSS_IMPORT_RULE,
  JS_CLASS_CSS_KEYFRAME_RULE,
  JS_CLASS_CSS_KEYFRAMES_RULE,
  JS_CLASS_CSS_LAYER_BLOCK_RULE,
  JS_CLASS_CSS_LAYER_STATEMENT_RULE,
