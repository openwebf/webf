...
// for ThreadState.
    ...
    public:
    FORCE_INLINE static ThreadStateStorage* MainThreadStateStorage() {
        return &main_thread_state_storage_;
    }

    FORCE_INLINE static ThreadStateStorage* Current() {
        return g_thread_specific_;
    }

    FORCE_INLINE cppgc::AllocationHandle& allocation_handle() const {
...
public:
    FORCE_INLINE static ThreadStateStorage* GetState() {
