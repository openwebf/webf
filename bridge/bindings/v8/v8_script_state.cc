...
// static
V8ScriptState* V8ScriptState::Create(v8::Local<v8::Context> context, ExecutionContext* execution_context) {
  return s_create_callback_(context, execution_context);
}

V8ScriptState::V8ScriptState(v8::Local<v8::Context> context, ExecutionContext* execution_context)
...
void V8ScriptState::OnV8ContextCollectedCallback(const v8::WeakCallbackInfo<V8ScriptState>& data) {
