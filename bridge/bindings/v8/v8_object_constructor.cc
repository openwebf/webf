...
v8::MaybeLocal<v8::Object> V8ObjectConstructor::NewInstance(v8::Isolate* isolate,
  ...
  v8::MicrotasksScope microtasks_scope(isolate, isolate->GetCurrentContext()->GetMicrotaskQueue(),
  ...
  v8::MaybeLocal<v8::Object> result = function->NewInstanceWithSideEffectType(isolate->GetCurrentContext(), argc, argv,
