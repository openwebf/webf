...
#include "bindings/v8/base/allocator/partition_allocator/src/partition_alloc/partition_alloc_base/apple/scoped_typeref.h"
...
struct ScopedCFTypeRefTraits {
  ...
  static CFT Retain(CFT object) {
    // TODO webf "ld: Undefined symbols: CFRetain"
//    CFRetain(object);
    return object;
  }
  static void Release(CFT object) {
    // TODO webf "ld: Undefined symbols: CFRelease"
//    CFRelease(object);
  }
};
