...
#include "bindings/v8/base/allocator/partition_allocator/src/partition_alloc/flags.h"
#include "bindings/v8/base/allocator/partition_allocator/src/partition_alloc/pointers/instance_tracer.h"
...
#if PA_BUILDFLAG(USE_RAW_PTR_BACKUP_REF_IMPL)
#include "bindings/v8/base/allocator/partition_allocator/src/partition_alloc/pointers/raw_ptr_backup_ref_impl.h"
...
#else
#include "bindings/v8/base/allocator/partition_allocator/src/partition_alloc/pointers/raw_ptr_noop_impl.h"
#endif
