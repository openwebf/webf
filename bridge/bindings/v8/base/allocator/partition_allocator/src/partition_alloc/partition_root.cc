...
//#include "bindings/v8/base/allocator/partition_allocator/src/partition_alloc/freeslot_bitmap.h"
...
//#include "bindings/v8/base/allocator/partition_allocator/src/partition_alloc/partition_cookie.h"
...
//#include "bindings/v8/base/allocator/partition_allocator/src/partition_alloc/thread_isolation/thread_isolation.h"
...
//      settings.extras_size += internal::kPartitionCookieSizeAdjustment;
    ...
    // TODO webf fix "No member named 'use_small_single_slot_spans' in 'partition_alloc::PartitionOptions'"
//    const bool use_small_single_slot_spans =
//        opts.use_small_single_slot_spans == PartitionOptions::kEnabled;
    const bool use_small_single_slot_spans = false;
