...
#ifndef WEBF_CHECKED_MATH_H
#define WEBF_CHECKED_MATH_H

#include <stdint.h>
#include <limits>
#include <type_traits>

#include "bindings/v8/base/numerics/checked_math_impl.h"  // IWYU pragma: export
#include "bindings/v8/base/numerics/safe_conversions.h"
#include "bindings/v8/base/numerics/safe_math_shared_impl.h"  // IWYU pragma: export
