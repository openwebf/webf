...
#ifndef WEBF_SAFE_MATH_SHARED_IMPL_H
#define WEBF_SAFE_MATH_SHARED_IMPL_H
...
#include "bindings/v8/base/numerics/safe_math_clang_gcc_impl.h"  // IWYU pragma: export
...
#endif  // WEBF_SAFE_MATH_SHARED_IMPL_H
