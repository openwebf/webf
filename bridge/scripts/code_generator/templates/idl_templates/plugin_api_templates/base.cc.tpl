...
#include "plugin_api_gen/<%= blob.filename.replace('plugin_api_', '') %>.h"
#include "plugin_api_gen/event_target.h"
#include "plugin_api_gen/add_event_listener_options.h"
#include "plugin_api_gen/event_listener_options.h"
#include "plugin_api_gen/performance_mark_options.h"
#include "plugin_api_gen/scroll_to_options.h"
