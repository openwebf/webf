    ...
    switch (templateKind) {
      case TemplateKind.Interface: {
        ...
        let wrapperTypeRegisterList = [
          ...
          object.construct ? `V8${className}::ConstructorCallback` : 'nullptr',     // ConstructorCallback
        ];
...
const WrapperTypeInfo V8${className}::wrapper_type_info_ {${wrapperTypeRegisterList.join(', ')}};
const WrapperTypeInfo& ${className}::wrapper_type_info_ = V8${className}::wrapper_type_info_;`;
