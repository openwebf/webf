...
static inline int _CodeUnitCompare(size_t l1,
                                  size_t l2,
                                  const char* c1,
                                  const char* c2) {
...
static inline int CodeUnitCompare8(const std::string& string1,
                                   const std::string& string2) {
  return _CodeUnitCompare(string1.length(), string2.length(),
                         string1.data(), string2.data());
}


static inline int CodeUnitCompare(const std::string& string1,
                                  const std::string& string2) {
  if (string1.empty())
