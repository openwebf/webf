...
#ifndef LEGACY_MULTI_THREADING_DOUBULE_UI_COMMAND_H_
#define LEGACY_MULTI_THREADING_DOUBULE_UI_COMMAND_H_
...
class LegacySharedUICommand : public DartReadable {
 public:
  LegacySharedUICommand(ExecutingContext* context);
 ...
 private:
  ...
  std::unique_ptr<LegacyUICommandSyncStrategy> ui_command_sync_strategy_ = nullptr;
  friend class UICommandBuffer;
  friend class LegacyUICommandSyncStrategy;
};


}  // namespace webf

#endif  // LEGACY_MULTI_THREADING_DOUBULE_UI_COMMAND_H_