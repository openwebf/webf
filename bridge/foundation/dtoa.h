...
const char* NumberToFixedPrecisionString(double, unsigned significant_figures, NumberToStringBuffer);
const char* NumberToFixedWidthString(double, unsigned decimal_places, NumberToStringBuffer);
