...
StringView::StringView(const unsigned char* string): bytes_(string), length_(strlen(reinterpret_cast<const char*>(string))), is_8bit_(true) {}
...
StringView::StringView(const StringView& view, unsigned offset, unsigned length): length_(length), is_8bit_(view.is_8bit_){
