...
class NthIndexCache;
class StyleScopeActivation;

// Global atoms are already defined in foundation/atomic_string.h
...
//    // https://crrev.com/c/3362008
 ...
 struct MatchResult {
  ...
  public:
   ...
   std::vector<Member<Element>>* has_argument_leftmost_compound_matches{
       nullptr};
...
private:
 ...
 const std::vector<AtomicString> pseudo_ident_list_;
 Mode mode_;
 bool is_ua_rule_;
#if DCHECK_IS_ON()
