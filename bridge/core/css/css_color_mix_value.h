...
class CSSColorMixValue : public CSSValue {
 public:
  CSSColorMixValue(const std::shared_ptr<const CSSValue>& color1,
                   const std::shared_ptr<const CSSValue>& color2,
                   const std::shared_ptr<const CSSPrimitiveValue>& p1,
                   const std::shared_ptr<const CSSPrimitiveValue>& p2,
