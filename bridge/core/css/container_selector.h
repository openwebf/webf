 ...
 public:
  ...
  bool operator==(const ContainerSelector& o) const {
    return (name_ == o.name_) && (physical_axes_ == o.physical_axes_) && (logical_axes_ == o.logical_axes_) &&
           (has_style_query_ == o.has_style_query_) && (has_sticky_query_ == o.has_sticky_query_) &&
  ...
  bool SelectsStateContainers() const { return SelectsStickyContainers() || SelectsSnapContainers(); }
