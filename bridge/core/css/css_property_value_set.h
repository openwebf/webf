...
class alignas(std::max(alignof(Member<const CSSValue>),
...
ImmutableCSSPropertyValueSet::MetadataArray() const {
  ...
  // Align it up.
  return reinterpret_cast<const CSSPropertyValueMetadata*>(AlignUp(
...
class MutableCSSPropertyValueSet : public CSSPropertyValueSet {
 public:
  ...
  CSSStyleDeclaration* EnsureCSSStyleDeclaration(
      ExecutingContext* execution_context);
 ...
 private:
  ...
  // nullptr).
  FORCE_INLINE CSSPropertyValue* FindInsertionPointForID(
