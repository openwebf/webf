...
#ifndef WEBF_CSS_PROPERTY_INSTANCES_H
#define WEBF_CSS_PROPERTY_INSTANCES_H
...
namespace css_longhand { class ScrollMarkers; }
...
inline const css_longhand::ScrollMarkers&
GetCSSPropertyScrollMarkers() {
  return *reinterpret_cast<const css_longhand::ScrollMarkers *>(
      GetPropertyInternal(CSSPropertyID::kScrollMarkers));
}
...
#endif  // WEBF_CSS_PROPERTY_INSTANCES_H
