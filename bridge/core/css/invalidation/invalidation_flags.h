...
#ifndef WEBF_CORE_CSS_INVALIDATION_INVALIDATION_FLAGS_H_
#define WEBF_CORE_CSS_INVALIDATION_INVALIDATION_FLAGS_H_
...
#endif  // WEBF_CORE_CSS_INVALIDATION_INVALIDATION_FLAGS_H_
