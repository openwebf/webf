...
const char* ScriptValueRefPublicMethods::ToString(webf::ScriptValueRef* script_value_ref, webf::SharedExceptionState* shared_exception_state) {
  ...
  shared_exception_state->exception_state.ThrowException(script_value_ref->context->ctx(), webf::ErrorType::TypeError, "Value is not a string.");
  return nullptr;
}

void ScriptValueRefPublicMethods::SetAsString(webf::ScriptValueRef* script_value_ref, const char* value, webf::SharedExceptionState* shared_exception_state) {
