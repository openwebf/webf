...
namespace webf{
    class FormData :public BindingObject{
        ...
        void append(const AtomicString& name, const std::shared_ptr<webf::BlobPart>& value, const AtomicString& fileName,ExceptionState& exception_state);
        ...
        void set(const AtomicString& name, const std::shared_ptr<webf::BlobPart>& value, const AtomicString& fileName,ExceptionState& exception_state);
        ...
        void forEach(const std::shared_ptr<webf::QJSFunction>& callback, const webf::ScriptValue& thisArg,ExceptionState& exception_state);
