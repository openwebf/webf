...
#include "core/base/buildflag.h"  // IWYU pragma: export
...
// more specific macro.
    ...
    defined(OS_LINUX) || defined(OS_CHROMEOS) || defined(OS_MAC) || defined(OS_NACL) || defined(OS_NETBSD) || \
    defined(OS_OPENBSD) || defined(OS_QNX) || defined(OS_SOLARIS) || defined(OS_ZOS)
#define OS_POSIX 1
#endif
