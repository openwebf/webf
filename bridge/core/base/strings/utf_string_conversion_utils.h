...
#ifndef WEBF_UTF_STRING_CONVERSION_UTILS_H
#define WEBF_UTF_STRING_CONVERSION_UTILS_H
...
std::optional<size_t> CountUnicodeCharacters(std::string_view text, size_t limit = std::numeric_limits<size_t>::max());
...
inline size_t WriteUnicodeCharacter(int32_t code_point, std::wstring* output) {
...
#endif  // WEBF_UTF_STRING_CONVERSION_UTILS_H
