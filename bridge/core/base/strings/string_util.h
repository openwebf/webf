...
namespace base {
extern const char kWhitespaceASCII[] = {0x09, /* CHARACTER TABULATION */
...
// NOTE: All sizes are in number of characters, NOT in bytes.
 ...
 size_t u16cstrlcpy(char16_t* dst,
                               const char16_t* src,
                               size_t dst_size);
...
// but will be compared unmodified.
 constexpr int CompareCaseInsensitiveASCII(std::string_view a,
                                                      std::string_view b) {
  return internal::CompareCaseInsensitiveASCIIT(a, b);
}
 constexpr int CompareCaseInsensitiveASCII(std::u16string_view a,
...
// (3) All other whitespace sequences are converted to single spaces.
 std::u16string CollapseWhitespace(
...
// |characters|.
 bool ContainsOnlyChars(std::string_view input,
