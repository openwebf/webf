...
#ifndef WEBF_STRING_UTIL_IMPL_HELPERS_H
#define WEBF_STRING_UTIL_IMPL_HELPERS_H
...
//                          << std::basic_string<CharT>(1, *i);
          ...
          if (offsets) {
            ...
            r_offsets.insert(
                webf::ranges::upper_bound(r_offsets, r_offset, &CompareParameter),
                r_offset);
          }
...
#endif  // WEBF_STRING_UTIL_IMPL_HELPERS_H
