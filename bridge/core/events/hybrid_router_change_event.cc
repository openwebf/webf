...
HybridRouterChangeEvent* HybridRouterChangeEvent::Create(ExecutingContext* context,
...
HybridRouterChangeEvent::HybridRouterChangeEvent(ExecutingContext* context, const AtomicString& type, ExceptionState& exception_state)
    : Event(context, type) {}
...
HybridRouterChangeEvent::HybridRouterChangeEvent(ExecutingContext* context, const AtomicString& type, NativeHybridRouterChangeEvent* native_event)
    : Event(context, type, &native_event->native_event),
      ...
      path_(AtomicString(ctx(),
                            std::unique_ptr<AutoFreeNativeString>(
                                reinterpret_cast<AutoFreeNativeString*>(native_event->path))))
#else
      state_(ScriptValue::CreateJsonObject(context->ctx(),
