...
Insets ToFlooredInsets(const InsetsF& insets) {
  return Insets::TLBR(base::ClampFloor(insets.top()), base::ClampFloor(insets.left()),
                      base::ClampFloor(insets.bottom()), base::ClampFloor(insets.right()));
}

Insets ToCeiledInsets(const InsetsF& insets) {
  return Insets::TLBR(base::ClampCeil(insets.top()), base::ClampCeil(insets.left()), base::ClampCeil(insets.bottom()),
                      base::ClampCeil(insets.right()));
}

Insets ToRoundedInsets(const InsetsF& insets) {
  return Insets::TLBR(base::ClampRound(insets.top()), base::ClampRound(insets.left()),
