...
class FontDescription {
 ...
 public:
  ...
  static std::string ToString(GenericFamilyType);
  ...
  static std::string ToString(LigaturesState);

  enum Kerning { kAutoKerning, kNormalKerning, kNoneKerning };
  static std::string ToString(Kerning);

  static std::string ToString(FontSelectionValue);
