...
class DOMMatrixReadOnly : public BindingObject {
 ...
 public:
  ...
  void setA_async(double v, ExceptionState& exception_state) { return setM11_async(v, exception_state); }
  ...
  void setB_async(double v, ExceptionState& exception_state) { return setM12_async(v, exception_state); }
  ...
  void setC_async(double v, ExceptionState& exception_state) { return setM21_async(v, exception_state); }
  ...
  void setD_async(double v, ExceptionState& exception_state) { return setM22_async(v, exception_state); }
  ...
  void setE_async(double v, ExceptionState& exception_state) { return setM41_async(v, exception_state); }
  ...
  void setF_async(double v, ExceptionState& exception_state) { return setM42_async(v, exception_state); }
