...
// located in //url, but KURL is backed by Blink specific webf::Strings. This
// means that KURLs are usually cheap to copy due to webf::Strings being
...
class  KURL {
 ...
 public:
  ...
  //
  // It is usually best to avoid repeatedly parsing a std::string, unless memory
...
//  KURL(const KURL& base, const std::string& relative, const webf::TextEncoding&);
