...
Window* Window::open(const AtomicString& url, ExceptionState& exception_state) {
  ...
  InvokeBindingMethod(binding_call_methods::kopen, 1, args, FlushUICommandReason::kDependentsOnElement, exception_state);
  return this;
}

Screen* Window::screen() {
  if (screen_ == nullptr) {
    NativeValue value = GetBindingProperty(binding_call_methods::kscreen, FlushUICommandReason::kDependentsOnElement | FlushUICommandReason::kDependentsOnLayout, ASSERT_NO_EXCEPTION());
...
void Window::scroll(double x, double y, ExceptionState& exception_state) {
  ...
  InvokeBindingMethod(binding_call_methods::kscroll, 2, args, FlushUICommandReason::kDependentsOnElement | FlushUICommandReason::kDependentsOnLayout, exception_state);
}
...
ComputedCssStyleDeclaration* Window::getComputedStyle(Element* element, ExceptionState& exception_state) {
  ...
  NativeValue result = InvokeBindingMethod(binding_call_methods::kgetComputedStyle, 1, arguments, FlushUICommandReason::kDependentsOnElement | FlushUICommandReason::kDependentsOnLayout, exception_state);
