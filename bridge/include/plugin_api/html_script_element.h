...
using PublicHTMLScriptElementGetSrc = AtomicStringRef (*)(HTMLScriptElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLScriptElementSetSrc = void (*)(HTMLScriptElement*, const char*, SharedExceptionState*);
using PublicHTMLScriptElementGetType = AtomicStringRef (*)(HTMLScriptElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLScriptElementSetType = void (*)(HTMLScriptElement*, const char*, SharedExceptionState*);
using PublicHTMLScriptElementGetNoModule = int32_t (*)(HTMLScriptElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLScriptElementSetNoModule = void (*)(HTMLScriptElement*, int32_t, SharedExceptionState*);
using PublicHTMLScriptElementGetAsync = int32_t (*)(HTMLScriptElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLScriptElementSetAsync = void (*)(HTMLScriptElement*, int32_t, SharedExceptionState*);
using PublicHTMLScriptElementGetText = AtomicStringRef (*)(HTMLScriptElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLScriptElementSetText = void (*)(HTMLScriptElement*, const char*, SharedExceptionState*);
using PublicHTMLScriptElementGetReadyState = AtomicStringRef (*)(HTMLScriptElement*, SharedExceptionState* shared_exception_state);
...
struct HTMLScriptElementPublicMethods : public WebFPublicMethods {
  static AtomicStringRef Src(HTMLScriptElement* html_script_element, SharedExceptionState* shared_exception_state);
  static void SetSrc(HTMLScriptElement* html_script_element, const char* src, SharedExceptionState* shared_exception_state);
  static AtomicStringRef Type(HTMLScriptElement* html_script_element, SharedExceptionState* shared_exception_state);
  static void SetType(HTMLScriptElement* html_script_element, const char* type, SharedExceptionState* shared_exception_state);
  static int32_t NoModule(HTMLScriptElement* html_script_element, SharedExceptionState* shared_exception_state);
  ...
  static int32_t Async(HTMLScriptElement* html_script_element, SharedExceptionState* shared_exception_state);
  static void SetAsync(HTMLScriptElement* html_script_element, int32_t async, SharedExceptionState* shared_exception_state);
  static AtomicStringRef Text(HTMLScriptElement* html_script_element, SharedExceptionState* shared_exception_state);
  static void SetText(HTMLScriptElement* html_script_element, const char* text, SharedExceptionState* shared_exception_state);
  static AtomicStringRef ReadyState(HTMLScriptElement* html_script_element, SharedExceptionState* shared_exception_state);
