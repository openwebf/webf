...
class Document;
using PublicDocumentGetAll = WebFValue<HTMLAllCollection, HTMLAllCollectionPublicMethods> (*)(Document*);
...
using PublicDocumentGetOnreadystatechange = WebFValue<IDLEventHandler, IDLEventHandlerPublicMethods> (*)(Document*);
using PublicDocumentSetOnreadystatechange = void (*)(Document*, IDLEventHandler*, SharedExceptionState*);
...
using PublicDocumentCreateElementNS = WebFValue<Element, ElementPublicMethods> (*)(Document*, int64_t, const char*, NativeValue, SharedExceptionState*);
...
struct DocumentPublicMethods : public WebFPublicMethods {
  static WebFValue<HTMLAllCollection, HTMLAllCollectionPublicMethods> All(Document* document);
  ...
  static WebFValue<IDLEventHandler, IDLEventHandlerPublicMethods> Onreadystatechange(Document* document);
  static void SetOnreadystatechange(Document* document, IDLEventHandler* onreadystatechange, SharedExceptionState* shared_exception_state);
  ...
  static WebFValue<Element, ElementPublicMethods> CreateElementNS(Document* document, int64_t uri, const char* tag_name, NativeValue options, SharedExceptionState* shared_exception_state);
  ...
  PublicDocumentGetAll document_get_all{All};
  ...
  PublicDocumentGetOnreadystatechange document_get_onreadystatechange{Onreadystatechange};
  PublicDocumentSetOnreadystatechange document_set_onreadystatechange{SetOnreadystatechange};
