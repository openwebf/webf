...
class Document;
using PublicDocumentGetTitle = NativeValue (*)(Document*, SharedExceptionState* shared_exception_state);
using PublicDocumentSetTitle = void (*)(Document*, const char*, SharedExceptionState*);
using PublicDocumentGetBody = WebFValue<webf::HTMLBodyElement, HTMLBodyElementPublicMethods> (*)(Document*);
using PublicDocumentSetBody = void (*)(Document*, HTMLBodyElement*, SharedExceptionState*);
using PublicDocumentGetCookie = NativeValue (*)(Document*, SharedExceptionState* shared_exception_state);
...
using PublicDocumentGetHead = WebFValue<webf::HTMLHeadElement, HTMLHeadElementPublicMethods> (*)(Document*);
using PublicDocumentGetDocumentElement = WebFValue<webf::HTMLHtmlElement, HTMLHtmlElementPublicMethods> (*)(Document*);
...
using PublicDocumentGetVisibilityState = NativeValue (*)(Document*, SharedExceptionState* shared_exception_state);
using PublicDocumentGetHidden = int32_t (*)(Document*);
using PublicDocumentGetDefaultView = WebFValue<webf::Window, WindowPublicMethods> (*)(Document*);
using PublicDocumentClearCookies = void (*)(Document*, SharedExceptionState*);
using PublicDocumentCreateElement = WebFValue<webf::Element, ElementPublicMethods> (*)(Document*, const char*, NativeValue, SharedExceptionState*);
using PublicDocumentCreateTextNode = WebFValue<webf::Text, TextPublicMethods> (*)(Document*, const char*, SharedExceptionState*);
using PublicDocumentCreateDocumentFragment = WebFValue<webf::DocumentFragment, DocumentFragmentPublicMethods> (*)(Document*, SharedExceptionState*);
using PublicDocumentCreateComment = WebFValue<webf::Comment, CommentPublicMethods> (*)(Document*, const char*, SharedExceptionState*);
using PublicDocumentCreateEvent = WebFValue<webf::Event, EventPublicMethods> (*)(Document*, const char*, SharedExceptionState*);
using PublicDocumentGetElementById = WebFValue<webf::Element, ElementPublicMethods> (*)(Document*, const char*, SharedExceptionState*);
...
using PublicDocumentQuerySelector = WebFValue<webf::Element, ElementPublicMethods> (*)(Document*, const char*, SharedExceptionState*);
using PublicDocumentQuerySelectorAll = VectorValueRef (*)(Document*, const char*, SharedExceptionState*);
using PublicDocumentElementFromPoint = WebFValue<webf::Element, ElementPublicMethods> (*)(Document*, double, double, SharedExceptionState*);
struct DocumentPublicMethods : public WebFPublicMethods {
  static NativeValue Title(Document* document, SharedExceptionState* shared_exception_state);
  static void SetTitle(Document* document, const char* title, SharedExceptionState* shared_exception_state);
  static WebFValue<webf::HTMLBodyElement, HTMLBodyElementPublicMethods> Body(Document* document);
  ...
  static WebFValue<webf::HTMLHeadElement, HTMLHeadElementPublicMethods> Head(Document* document);
  static WebFValue<webf::HTMLHtmlElement, HTMLHtmlElementPublicMethods> DocumentElement(Document* document);
  ...
  static NativeValue VisibilityState(Document* document, SharedExceptionState* shared_exception_state);
  static int32_t Hidden(Document* document);
  static WebFValue<webf::Window, WindowPublicMethods> DefaultView(Document* document);
  static void ClearCookies(Document* document, SharedExceptionState* shared_exception_state);
  static WebFValue<webf::Element, ElementPublicMethods> CreateElement(Document* document, const char* tag_name, NativeValue options, SharedExceptionState* shared_exception_state);
  static WebFValue<webf::Text, TextPublicMethods> CreateTextNode(Document* document, const char* value, SharedExceptionState* shared_exception_state);
  static WebFValue<webf::DocumentFragment, DocumentFragmentPublicMethods> CreateDocumentFragment(Document* document, SharedExceptionState* shared_exception_state);
  static WebFValue<webf::Comment, CommentPublicMethods> CreateComment(Document* document, const char* data, SharedExceptionState* shared_exception_state);
  static WebFValue<webf::Event, EventPublicMethods> CreateEvent(Document* document, const char* event_type, SharedExceptionState* shared_exception_state);
  static WebFValue<webf::Element, ElementPublicMethods> GetElementById(Document* document, const char* id, SharedExceptionState* shared_exception_state);
  ...
  static WebFValue<webf::Element, ElementPublicMethods> QuerySelector(Document* document, const char* selectors, SharedExceptionState* shared_exception_state);
  ...
  static WebFValue<webf::Element, ElementPublicMethods> ElementFromPoint(Document* document, double x, double y, SharedExceptionState* shared_exception_state);
  double version{1.0};
