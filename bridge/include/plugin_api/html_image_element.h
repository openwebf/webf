...
using PublicHTMLImageElementGetAlt = AtomicStringRef (*)(HTMLImageElement*, SharedExceptionState* shared_exception_state);
...
using PublicHTMLImageElementGetSizes = AtomicStringRef (*)(HTMLImageElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLImageElementSetSizes = void (*)(HTMLImageElement*, const char*, SharedExceptionState*);
using PublicHTMLImageElementGetWidth = int64_t (*)(HTMLImageElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLImageElementSetWidth = void (*)(HTMLImageElement*, int64_t, SharedExceptionState*);
using PublicHTMLImageElementGetHeight = int64_t (*)(HTMLImageElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLImageElementSetHeight = void (*)(HTMLImageElement*, int64_t, SharedExceptionState*);
using PublicHTMLImageElementGetNaturalWidth = int64_t (*)(HTMLImageElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLImageElementGetNaturalHeight = int64_t (*)(HTMLImageElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLImageElementGetComplete = int32_t (*)(HTMLImageElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLImageElementGetCurrentSrc = AtomicStringRef (*)(HTMLImageElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLImageElementGetDecoding = AtomicStringRef (*)(HTMLImageElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLImageElementSetDecoding = void (*)(HTMLImageElement*, const char*, SharedExceptionState*);
using PublicHTMLImageElementGetFetchPriority = AtomicStringRef (*)(HTMLImageElement*, SharedExceptionState* shared_exception_state);
using PublicHTMLImageElementSetFetchPriority = void (*)(HTMLImageElement*, const char*, SharedExceptionState*);
using PublicHTMLImageElementGetLoading = AtomicStringRef (*)(HTMLImageElement*, SharedExceptionState* shared_exception_state);
...
struct HTMLImageElementPublicMethods : public WebFPublicMethods {
  static AtomicStringRef Alt(HTMLImageElement* html_image_element, SharedExceptionState* shared_exception_state);
  ...
  static AtomicStringRef Sizes(HTMLImageElement* html_image_element, SharedExceptionState* shared_exception_state);
  static void SetSizes(HTMLImageElement* html_image_element, const char* sizes, SharedExceptionState* shared_exception_state);
  static int64_t Width(HTMLImageElement* html_image_element, SharedExceptionState* shared_exception_state);
  static void SetWidth(HTMLImageElement* html_image_element, int64_t width, SharedExceptionState* shared_exception_state);
  static int64_t Height(HTMLImageElement* html_image_element, SharedExceptionState* shared_exception_state);
  static void SetHeight(HTMLImageElement* html_image_element, int64_t height, SharedExceptionState* shared_exception_state);
  static int64_t NaturalWidth(HTMLImageElement* html_image_element, SharedExceptionState* shared_exception_state);
  static int64_t NaturalHeight(HTMLImageElement* html_image_element, SharedExceptionState* shared_exception_state);
  static int32_t Complete(HTMLImageElement* html_image_element, SharedExceptionState* shared_exception_state);
  static AtomicStringRef CurrentSrc(HTMLImageElement* html_image_element, SharedExceptionState* shared_exception_state);
  static AtomicStringRef Decoding(HTMLImageElement* html_image_element, SharedExceptionState* shared_exception_state);
  ...
  static AtomicStringRef FetchPriority(HTMLImageElement* html_image_element, SharedExceptionState* shared_exception_state);
  ...
  static AtomicStringRef Loading(HTMLImageElement* html_image_element, SharedExceptionState* shared_exception_state);
