...
using PublicNodeGetChildNodes = WebFValue<webf::NodeList, NodeListPublicMethods> (*)(Node*);
using PublicNodeGetFirstChild = WebFValue<webf::Node, NodePublicMethods> (*)(Node*);
using PublicNodeGetIsConnected = int32_t (*)(Node*);
using PublicNodeGetLastChild = WebFValue<webf::Node, NodePublicMethods> (*)(Node*);
using PublicNodeGetNextSibling = WebFValue<webf::Node, NodePublicMethods> (*)(Node*);
using PublicNodeGetOwnerDocument = WebFValue<webf::Document, DocumentPublicMethods> (*)(Node*);
using PublicNodeGetParentElement = WebFValue<webf::Element, ElementPublicMethods> (*)(Node*);
using PublicNodeGetParentNode = WebFValue<webf::Node, NodePublicMethods> (*)(Node*);
using PublicNodeGetPreviousSibling = WebFValue<webf::Node, NodePublicMethods> (*)(Node*);
using PublicNodeHasChildNodes = int32_t (*)(Node*, SharedExceptionState*);
using PublicNodeAppendChild = WebFValue<webf::Node, NodePublicMethods> (*)(Node*, Node*, SharedExceptionState*);
using PublicNodeCloneNode = WebFValue<webf::Node, NodePublicMethods> (*)(Node*, int32_t, SharedExceptionState*);
using PublicNodeContains = int32_t (*)(Node*, Node*, SharedExceptionState*);
using PublicNodeInsertBefore = WebFValue<webf::Node, NodePublicMethods> (*)(Node*, Node*, Node*, SharedExceptionState*);
...
using PublicNodeRemoveChild = WebFValue<webf::Node, NodePublicMethods> (*)(Node*, Node*, SharedExceptionState*);
using PublicNodeRemove = void (*)(Node*, SharedExceptionState*);
using PublicNodeReplaceChild = WebFValue<webf::Node, NodePublicMethods> (*)(Node*, Node*, Node*, SharedExceptionState*);
struct NodePublicMethods : public WebFPublicMethods {
  ...
  static WebFValue<webf::NodeList, NodeListPublicMethods> ChildNodes(Node* node);
  static WebFValue<webf::Node, NodePublicMethods> FirstChild(Node* node);
  static int32_t IsConnected(Node* node);
  static WebFValue<webf::Node, NodePublicMethods> LastChild(Node* node);
  static WebFValue<webf::Node, NodePublicMethods> NextSibling(Node* node);
  static WebFValue<webf::Document, DocumentPublicMethods> OwnerDocument(Node* node);
  static WebFValue<webf::Element, ElementPublicMethods> ParentElement(Node* node);
  static WebFValue<webf::Node, NodePublicMethods> ParentNode(Node* node);
  static WebFValue<webf::Node, NodePublicMethods> PreviousSibling(Node* node);
  static int32_t HasChildNodes(Node* node, SharedExceptionState* shared_exception_state);
  static WebFValue<webf::Node, NodePublicMethods> AppendChild(Node* node, Node* new_node, SharedExceptionState* shared_exception_state);
  static WebFValue<webf::Node, NodePublicMethods> CloneNode(Node* node, int32_t deep, SharedExceptionState* shared_exception_state);
  static int32_t Contains(Node* node, Node* other, SharedExceptionState* shared_exception_state);
  static WebFValue<webf::Node, NodePublicMethods> InsertBefore(Node* node, Node* new_child, Node* ref_child, SharedExceptionState* shared_exception_state);
  ...
  static WebFValue<webf::Node, NodePublicMethods> RemoveChild(Node* node, Node* old_child, SharedExceptionState* shared_exception_state);
  static void Remove(Node* node, SharedExceptionState* shared_exception_state);
  static WebFValue<webf::Node, NodePublicMethods> ReplaceChild(Node* node, Node* new_child, Node* old_child, SharedExceptionState* shared_exception_state);
  double version{1.0};
