...
using PublicElementGetDataset = WebFValue<webf::DOMStringMap, DOMStringMapPublicMethods> (*)(Element*);
using PublicElementGetName = NativeValue (*)(Element*, SharedExceptionState* shared_exception_state);
using PublicElementSetName = void (*)(Element*, const char*, SharedExceptionState*);
using PublicElementGetAttributes = WebFValue<webf::ElementAttributes, ElementAttributesPublicMethods> (*)(Element*);
using PublicElementGetStyle = WebFValue<webf::CSSStyleDeclaration, CSSStyleDeclarationPublicMethods> (*)(Element*);
using PublicElementGetClientHeight = NativeValue (*)(Element*, SharedExceptionState* shared_exception_state);
using PublicElementGetClientLeft = NativeValue (*)(Element*, SharedExceptionState* shared_exception_state);
using PublicElementGetClientTop = NativeValue (*)(Element*, SharedExceptionState* shared_exception_state);
using PublicElementGetClientWidth = NativeValue (*)(Element*, SharedExceptionState* shared_exception_state);
...
using PublicElementGetOwnerDocument = WebFValue<webf::Document, DocumentPublicMethods> (*)(Element*);
using PublicElementGetScrollLeft = NativeValue (*)(Element*, SharedExceptionState* shared_exception_state);
using PublicElementSetScrollLeft = void (*)(Element*, double, SharedExceptionState*);
using PublicElementGetScrollTop = NativeValue (*)(Element*, SharedExceptionState* shared_exception_state);
using PublicElementSetScrollTop = void (*)(Element*, double, SharedExceptionState*);
using PublicElementGetScrollWidth = NativeValue (*)(Element*, SharedExceptionState* shared_exception_state);
using PublicElementGetScrollHeight = NativeValue (*)(Element*, SharedExceptionState* shared_exception_state);
using PublicElementGetLocalName = AtomicStringRef (*)(Element*);
using PublicElementGetTagName = AtomicStringRef (*)(Element*);
using PublicElementGetDir = NativeValue (*)(Element*, SharedExceptionState* shared_exception_state);
...
using PublicElementGetBoundingClientRect = WebFValue<webf::BoundingClientRect, BoundingClientRectPublicMethods> (*)(Element*, SharedExceptionState*);
...
using PublicElementQuerySelector = WebFValue<webf::Element, ElementPublicMethods> (*)(Element*, const char*, SharedExceptionState*);
...
struct ElementPublicMethods : public WebFPublicMethods {
  ...
  static WebFValue<webf::DOMStringMap, DOMStringMapPublicMethods> Dataset(Element* element);
  static NativeValue Name(Element* element, SharedExceptionState* shared_exception_state);
  static void SetName(Element* element, const char* name, SharedExceptionState* shared_exception_state);
  static WebFValue<webf::ElementAttributes, ElementAttributesPublicMethods> Attributes(Element* element);
  static WebFValue<webf::CSSStyleDeclaration, CSSStyleDeclarationPublicMethods> Style(Element* element);
  static NativeValue ClientHeight(Element* element, SharedExceptionState* shared_exception_state);
  static NativeValue ClientLeft(Element* element, SharedExceptionState* shared_exception_state);
  static NativeValue ClientTop(Element* element, SharedExceptionState* shared_exception_state);
  static NativeValue ClientWidth(Element* element, SharedExceptionState* shared_exception_state);
  ...
  static WebFValue<webf::Document, DocumentPublicMethods> OwnerDocument(Element* element);
  static NativeValue ScrollLeft(Element* element, SharedExceptionState* shared_exception_state);
  static void SetScrollLeft(Element* element, double scrollLeft, SharedExceptionState* shared_exception_state);
  static NativeValue ScrollTop(Element* element, SharedExceptionState* shared_exception_state);
  static void SetScrollTop(Element* element, double scrollTop, SharedExceptionState* shared_exception_state);
  static NativeValue ScrollWidth(Element* element, SharedExceptionState* shared_exception_state);
  static NativeValue ScrollHeight(Element* element, SharedExceptionState* shared_exception_state);
  static AtomicStringRef LocalName(Element* element);
  static AtomicStringRef TagName(Element* element);
  static NativeValue Dir(Element* element, SharedExceptionState* shared_exception_state);
  ...
  static WebFValue<webf::BoundingClientRect, BoundingClientRectPublicMethods> GetBoundingClientRect(Element* element, SharedExceptionState* shared_exception_state);
  ...
  static WebFValue<webf::Element, ElementPublicMethods> QuerySelector(Element* element, const char* selectors, SharedExceptionState* shared_exception_state);
