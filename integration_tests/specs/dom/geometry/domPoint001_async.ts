...
test(async function(done) {
  await checkDOMPointAsync(new DOMPoint(), {x:0, y:0, z:0, w:1});
  done();
},'async testConstructor0');
test(async function(done) {
  await checkDOMPointAsync(new DOMPoint(1), {x:1, y:0, z:0, w:1});
  done();
},'async testConstructor1');
test(async function(done) {
  await checkDOMPointAsync(new DOMPoint(1, 2), {x:1, y:2, z:0, w:1});
  done();
},'async testConstructor2');
test(async function(done) {
  await checkDOMPointAsync(new DOMPoint(1, 2, 3), {x:1, y:2, z:3, w:1});
  done();
},'async testConstructor3');
test(async function(done) {
  await checkDOMPointAsync(new DOMPoint(1, 2, 3, 4), {x:1, y:2, z:3, w:4});
  done();
},'async testConstructor4');
test(async function(done) {
  await checkDOMPointAsync(new DOMPoint(1, 2, 3, 4, 5), {x:1, y:2, z:3, w:4});
  done();
},'async testConstructor5');
// test(async function(done) {
//   await checkDOMPointAsync(new DOMPoint({}), {x:NaN, y:0, z:0, w:1});
//   done();
// },'async testConstructorDictionary0'); //TODO
// test(async function(done) {
//   await checkDOMPointAsync(new DOMPoint({x:1}), {x:NaN, y:0, z:0, w:1});
//   done();
// },'async testConstructorDictionary1'); //TODO
// test(async function(done) {
//   await checkDOMPointAsync(new DOMPoint({x:1, y:2}), {x:NaN, y:0, z:0, w:1});
//   done();
// },'async testConstructorDictionary2'); //TODO
test(async function(done) {
  await checkDOMPointAsync(new DOMPoint(1, undefined), {x:1, y:0, z:0, w:1});
  done();
...
test(async function(done) {
  await checkDOMPointAsync(new DOMPointReadOnly(), {x:0, y:0, z:0, w:1});
  done();
},'async DOMPointReadOnly constructor with no values');
test(async function(done) {
  await checkDOMPointAsync(new DOMPointReadOnly(1, 2, 3, 4), {x:1, y:2, z:3, w:4});
  done();
