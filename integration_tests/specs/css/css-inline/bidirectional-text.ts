describe('Bidirectional Text (Phase 1)', () => {
  ...
  it('should handle RTL with floats', async () => {
    const container = document.createElement('div');
    container.style.direction = 'rtl';
    container.style.width = '400px';
    container.style.border = '1px solid black';
    ...
    floatLeft.style.width = '100px';
    floatLeft.style.height = '50px';
    floatLeft.style.background = 'red';
    floatLeft.style.margin = '5px';
    floatLeft.textContent = 'Float left';
    
    const floatRight = document.createElement('div');
    floatRight.style.float = 'right';
    floatRight.style.width = '100px';
    floatRight.style.height = '50px';
    floatRight.style.background = 'blue';
    floatRight.style.margin = '5px';
    floatRight.textContent = 'Float right';
    
    const text = document.createElement('p');
    text.textContent = 'نص عربي يتدفق حول العناصر العائمة في سياق RTL';
    
    container.appendChild(floatLeft);
    container.appendChild(floatRight);
