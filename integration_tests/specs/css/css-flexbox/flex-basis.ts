...
describe('flex-basis', () => {
  ...
  it('should properly layout text in flex items with flex 003', async () => {
    // Create the outer container
    const div1 = document.createElement('div');
    div1.id = 'div_1';
    div1.style.display = 'flex';
    ...
    divBuy.style.zIndex = '20';
    divBuy.style.fontSize = '16px';
    divBuy.textContent = 'Buy111222333Buy111222333Buy';
  ...
  it('should properly layout text in flex items with flex 004', async () => {
    // Create the outer container
    const div1 = document.createElement('div');
    div1.id = 'div_1';
    div1.style.display = 'flex';
    ...
    divBuy.style.zIndex = '20';
    divBuy.style.fontSize = '16px';
    divBuy.textContent = 'Buy111222333 Buy111222333Buy';
