describe('CSS1 vertical-align', () => {
  xit('aligns inline content in multiple ways', async () => {
...
.midalign {vertical-align: middle;}
      ...
      <hr>
      <p>
        <img src="../resources/vblank.gif" alt="[Image]" height="50">
        <span class="one">The first four words</span> in this sentence should be subscript-aligned. The font size of the superscripted text should not be different from that of the parent element.
      </p>
      <p>
        <img src="../resources/vblank.gif" alt="[Image]" height="50">
        <span class="two">The first four words</span> in this sentence should be superscript-aligned. The font size of the subscripted text should not be different from that of the parent element.
      </p>
      <p>
        <img src="../resources/vblank.gif" alt="[Image]" height="50">
      ...
      <p>
        <img src="../resources/vblank.gif" alt="[Image]" height="50" class="five">
      ...
      <p>
        <img src="../resources/vblank.gif" alt="[Image]" height="50" align="top">
        <span style="font-size: 200%;">
      ...
      <p>In the following paragraph, all images should be aligned with the top of the 14-point text, which is identical to the first section of text, whereas any size text should be aligned with the text baseline (which is the default value).</p>
      <p class="example">
        This paragraph
        <img src="../resources/vblank.gif" alt="[Image]" height="30" class="ttopalign">
        <span style="font-size: 250%;">contains many images</span>
        <img src="../resources/vblank.gif" alt="[Image]" height="50" class="ttopalign">
        <big>of varying heights</big>
        <img src="../resources/vblank.gif" alt="[Image]" height="10" class="ttopalign">
        <small>and widths</small>
        <img src="../resources/vblank.gif" alt="[Image]" height="20" class="ttopalign">
        all of which
        <img src="../resources/vblank.gif" alt="[Image]" height="65" class="ttopalign">
        <span style="font-size: 2em;">should be aligned</span>
        <img src="../resources/vblank.gif" alt="[Image]" height="35" class="ttopalign">
        with the top of
        <img src="../resources/vblank.gif" alt="[Image]" height="30" class="ttopalign">
        ...
        <img src="../resources/vblank.gif" alt="[Image]" height="15" class="ttopalign">
        <big>the images appear.</big>
        <img src="../resources/vblank.gif" alt="[Image]" height="90" class="ttopalign">
      </p>
      <p class="explain">
      ...
      <p>
        This paragraph
        <img src="../resources/vblank.gif" alt="[Image]" height="30" class="midalign">
        <span style="font-size: 250%;">contains many images</span>
        <img src="../resources/vblank.gif" alt="[Image]" height="50" class="midalign">
        of varying heights
        <img src="../resources/vblank.gif" alt="[Image]" height="10" class="midalign">
        <small>and widths</small>
        <img src="../resources/vblank.gif" alt="[Image]" height="20" class="midalign">
        all of which
        <img src="../resources/vblank.gif" alt="[Image]" height="65" class="midalign">
        should be aligned
        <img src="../resources/vblank.gif" alt="[Image]" height="35" class="midalign">
        <span style="font-size: 2em;">with the middle of</span>
        <img src="../resources/vblank.gif" alt="[Image]" height="50" class="midalign">
        <span style="font-size: 150%;">a <span style="font-size: 250%;">14-point</span> text element</span>
        <img src="../resources/vblank.gif" alt="[Image]" height="50" class="midalign">
        <small>regardless of the line in which</small>
        <img src="../resources/vblank.gif" alt="[Image]" height="15" class="midalign">
        <big>the images appear.</big>
        <img src="../resources/vblank.gif" alt="[Image]" height="90" class="midalign">
      </p>
      <p class="explain">
      ...
      <p>
        ...
        <img src="../resources/vblank.gif" alt="[Image]" height="10" class="topalign">
        ...
        <img src="../resources/vblank.gif" alt="[Image]" height="20" class="topalign">
        <span class="topalign">all of which</span>
        <img src="../resources/vblank.gif" alt="[Image]" height="65" class="topalign">
        <span class="topalign">should be aligned</span>
        <img src="../resources/vblank.gif" alt="[Image]" height="35" class="topalign">
        <span style="font-size: 2em;" class="topalign">with the top of</span>
        <img src="../resources/vblank.gif" alt="[Image]" height="50" class="topalign">
        <span class="topalign">the tallest element in</span>
        <img src="../resources/vblank.gif" alt="[Image]" height="15" class="topalign">
        <big class="topalign">whichever line the elements appear.</big>
        <img src="../resources/vblank.gif" alt="[Image]" height="90" class="topalign">
      </p>
    `;
