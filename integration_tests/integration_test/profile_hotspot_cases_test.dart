...
<head>
  <style>
    ...
    #board.phase-1 .title-slot {
      width: 68px;
    }
    #board.phase-1 .trailing-slot {
      width: 68px;
    }
    #board.phase-2 .card {
      width: 168px;
    ...
    #board.phase-2 .status-slot {
      width: 58px;
    }
    #board.phase-2 .soft-slot {
      width: 66px;
    }
